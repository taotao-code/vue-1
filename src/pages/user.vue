...
<style scoped>
  ...
  .content .header{width:6.4rem;height:3.4rem; background:#9e9a95; padding-top:0.4rem;z-index: 999;}
  .header h2{width:1.02rem;height:1.02rem; border-radius:50%; margin:0 auto;}
  .header h2 img{width:100%;}
  .header .user-box{width:1.54rem; font-size:0.25rem; color:#fff; margin:0 auto; margin-top:0.2rem;}
  ...
  .content .docList{width:6.4rem; margin:0 auto; margin-top:0.62rem;}
  ...
  .docList ul .mm-text i{width:0.29rem;height:0.35rem; background:url(../assets/img/fx.png) no-repeat 0 0; background-size:100%; float:left; margin-left:0.32rem; margin-top:0.24rem;}
  ...
  .docList ul .my_cz i{width:0.37rem;height:0.37rem; background:url(../assets/img/my.png) no-repeat 0 0; background-size:100%; float:left; margin-left:0.29rem; margin-top:0.24rem;}
